            ...
            <div class="card-body text-center">
                <div class="list-menu">
                    <div class="item-menu text-center">
                        <div class="menu-icon">
                            <a href="/editprofile" style="font-size: 40px; color: #34c759;">
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="medkit-outline" style="font-size: 1.6rem; color: #FDD835"
                                class="mb-1"></ion-icon>
                            <br>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="document-outline" style="font-size: 1.6rem; color: #dc3545"
                                class="mb-1"></ion-icon>
                            <br>
